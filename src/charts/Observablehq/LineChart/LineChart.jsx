...
const data = fetch.map(item => ({date: new Date(item.date), close: item.close}))
...
const LineChart = () => {
    ...
    let xType = d3.scaleTime // the x-scale type
    ...
    let color = "currentColor" // stroke color of line
